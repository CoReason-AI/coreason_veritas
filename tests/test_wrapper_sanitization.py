...
def sign_payload(payload: Dict[str, Any], private_key: rsa.RSAPrivateKey) -> str:
...
@pytest.mark.asyncio
async def test_wrapper_sanitization_async(mock_env):
    ...
    async def run_agent(spec, sig, user, config):
        return config
...
def test_wrapper_sanitization_sync(mock_env):
    ...
    def run_agent(spec, sig, user, config):
        return config
...
@pytest.mark.asyncio
async def test_wrapper_sanitization_async_gen(mock_env):
    ...
    async def run_agent(spec, sig, user, config) -> AsyncGenerator[Dict[str, Any], None]:
        yield config
...
def test_wrapper_sanitization_sync_gen(mock_env):
    ...
    def run_agent(spec, sig, user, config) -> Generator[Dict[str, Any], None, None]:
        yield config
