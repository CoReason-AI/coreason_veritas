...
def test_seal_missing_key(monkeypatch: Any) -> None:
...
def test_seal_success(monkeypatch: Any, private_key: Any, pem_public: str) -> None:
...
def test_seal_tampered(monkeypatch: Any, private_key: Any, pem_public: str) -> None:
...
def test_load_private_key_fail(monkeypatch: Any) -> None:
