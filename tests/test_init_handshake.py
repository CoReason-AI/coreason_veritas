...
def test_init_audit_handshake(caplog):
    """
    ...
    mock_auditor_module.IERLogger = mock_ier_logger_class
...
def test_init_audit_handshake_failure(caplog):
    """
